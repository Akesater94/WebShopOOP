    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShippingAlternatives", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StreetNumber = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingAlternativeId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_ShippingAlternatives_ShippingAlternativeId",
                        column: x => x.ShippingAlternativeId,
                        principalTable: "ShippingAlternatives",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShoppingCartRows", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShoppingCartRows_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShoppingCartRows_ShoppingCarts_ShoppingCartId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_ShippingAlternativeId",
                table: "Orders",
                column: "ShippingAlternativeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCartRows_ProductId",
                table: "ShoppingCartRows",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCartRows_ShoppingCartId",
                table: "ShoppingCartRows",
